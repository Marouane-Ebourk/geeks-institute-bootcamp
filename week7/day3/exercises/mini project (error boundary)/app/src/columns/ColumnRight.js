...
export const ColumnRight = () => {
    ...
    return (
        <Container className="column-right">
            ...
            <p>
                There are two types of errors we can trigger inside this
                component: A rendering error and a regular javascript error.
            </p>
            ...
            <ErrorBoundary>
                <p>
                    ...
                    <code>stringified</code> object, <code>{text}</code>, with
            ...
            <p>
                Clicking this button will invoke an event handler, inside of
                which an error is thrown.
            </p>
